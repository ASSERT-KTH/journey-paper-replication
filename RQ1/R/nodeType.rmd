...
commons_codec <- read_delim("../data/nodeType/commons-codec.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
commons_collections <- read_delim("../data/nodeType/commons-collections.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
commons_io <- read_delim("../data/nodeType/commons-io.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
commons_lang <- read_delim("../data/nodeType/commons-lang.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
gson <- read_delim("../data/nodeType/gson.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
jgit <- read_delim("../data/nodeType/jgit.csv", 
    ",", escape_double = FALSE, trim_ws = TRUE)
